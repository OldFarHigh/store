    ...
    <y-shelf title="支付订单">
      <div slot="content">
        ...
        <div class="pay-info">
          ...
          <span style="color:red">*</span> 金额：<el-select class="money-select" v-model="moneySelect" placeholder="请选择支付金额" @change="changeSelect">
            <el-option label="￥1.00 " value="1.00"></el-option>
            <el-option label="￥38.00" value="38.00"></el-option>
            <el-option label="自定义 随意撒币" value="custom"></el-option>
          </el-select><br>
          <div v-if="moneySelect === 'custom'"><span style="color:red">*</span> 输入金额：<el-input v-model="money" placeholder="请输入金额(最多2位小数，不得低于0.1元)" @change="checkValid" :maxlength="maxLength" class="input" style="margin-left:10px"></el-input><br></div>
        ...
        <div class="pay-type">
          ...
          <div class="pay-item">
            <div :class="{active:payType==1}" @click="payType=1"><img src="" alt=""></div>
            <div :class="{active:payType==2}" @click="payType=2"><img src="" alt=""></div>
            <div :class="{active:payType==3}" @click="payType=3"><img src="" alt=""></div>
          </div>
        </div>
