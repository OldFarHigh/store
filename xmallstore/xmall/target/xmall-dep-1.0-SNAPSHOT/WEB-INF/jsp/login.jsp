...
<head>
    ...
    <!-- css files -->
    <link rel="stylesheet" href="lib/login/style.css" type="text/css" media="all"/>
    <!-- Style-CSS -->
...
<div data-vide-bg="lib/video/Ipad">
    <div class="center-container">
        ...
        <div class="header-w3l">
            <h1>商城<span class="title">后台管理系统</span></h1>
        </div>
        <!--//header-->
        <div class="main-content-agile">
            <div class="sub-main-w3">
                ...
                <form id="login" action="" method="post" width="100%">
                    <input placeholder="用户名" name="username" id="username" class="user" type="text"
                           required="">
        ...
        <!--footer-->
        <div class="footer">
            <p>&copy; 2019 All rights reserved | Design by <a href="" target="_blank"></a></p>
        </div>
        <!--//footer-->
    </div>
</div>
    ...
    $.ajax({
      ...
      error: function (XMLHttpRequest) {
        layer.alert('数据处理失败! 错误码:' + XMLHttpRequest.status + ' 错误信息:' + JSON.parse(
            XMLHttpRequest.responseText).message, {title: '错误信息', icon: 2});
        $("#loginButton").val("登录");
        $("#loginButton").removeAttr("disabled");
      }
    });
