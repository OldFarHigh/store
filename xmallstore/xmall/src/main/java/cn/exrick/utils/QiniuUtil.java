...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "gTAR5obwKImqdUGv-xyjwvhZfm5_2tUAsyhN5e2u";
    private static String secretKey = "O-ZrkDOtPBVUyVvql7YGPi8EPD0azPBj-13Rajvz";
    private static String bucket = "xmallstore";
    private static String origin="http://q0w80alom.bkt.clouddn.com/";
